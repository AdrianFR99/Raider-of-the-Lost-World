...
bool j1App::Awake()
{
	...
	if(config.empty() == false)
	{
		...
		framerateCap = config.child("app").child("Framerate").attribute("framerate_cap").as_uint();
	}
...
void j1App::FinishUpdate()
{
	...
	// accurately the amount of time it SDL_Delay actually waits compared to what was expected
